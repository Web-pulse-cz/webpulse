...
const pageTitle = ref('Informační stránky');
...
async function loadItems() {
  ...
  await client<{ id: number }>('/api/admin/page', {
    method: 'GET',
    ...
    .catch(() => {
      ...
      toast.add({
        title: 'Chyba',
        description: 'Nepodařilo se načíst stránky. Zkuste to prosím později.',
        color: 'red',
      });
    })
    .finally(() => {
...
async function deleteItem(id: number) {
  ...
  await client<{ id: number }>('/api/admin/page/' + id, {
    method: 'DELETE',
    headers: {
      Accept: 'application/json',
      'Content-Type': 'application/json',
    ...
    .catch(() => {
      ...
      toast.add({
        title: 'Chyba',
        description: 'Nepodařilo se smazat položku informační stránky.',
        color: 'red',
      });
    })
    .finally(() => {

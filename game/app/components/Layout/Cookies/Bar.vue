...
<template>
  <div>
    ...
    <div
      v-if="showIcon"
      class="fixed bottom-0 left-0 right-8 z-10 flex h-12 w-12 cursor-pointer items-center justify-center rounded border border-brand bg-footerGray p-2 md:bottom-4 md:left-4"
    >

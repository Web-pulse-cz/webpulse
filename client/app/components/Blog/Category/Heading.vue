...
export interface BlogCategoryHeadingProps {
  category: PostCategory;
}

const props = defineProps<BlogCategoryHeadingProps>();
...
<template>
  ...
  >
    ...
    <p v-if="category.description" class="mt-4 max-w-2xl text-lg text-text-secondary md:text-xl">

export default {
  ...
  cookies: {
    title: 'Cookies',
    description:
      'Táto stránka používa cookies na zabezpečenie správneho fungovania a zlepšenie vášho používateľského zážitku.',
    ...
    marketingCookiesDescription:
      'Marketingové cookies slúžia na zobrazovanie reklám, ktoré sú pre vás relevantné. Pomáhajú nám sledovať a vyhodnocovať účinnosť našich reklamných kampaní. Tieto cookies môžete odmietnuť.',

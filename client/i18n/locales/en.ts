export default {
  ...
  cookies: {
    title: 'Cookies',
    description:
      'This website uses cookies to ensure proper functionality and enhance your user experience.',
    ...
    technicalCookiesDescription:
      'Technical cookies are essential for the proper functioning of the website. They ensure security, correct display across devices, enable form submissions, cart management, and login. Without these cookies, the e-shop will not function. These cookies cannot be refused.',
    marketingCookiesTitle: 'Marketing cookies',
    marketingCookiesDescription:
      'Marketing cookies are used to display ads that are relevant to you. They help us track and evaluate the effectiveness of our advertising campaigns. You may refuse these cookies.',
    analyticsCookiesTitle: 'Analytics cookies',
    analyticsCookiesDescription:
      'Analytics cookies provide us with information about how you use our website and services. They help us continuously improve content and user experience and monitor the success of advertising campaigns. You may refuse these cookies.',

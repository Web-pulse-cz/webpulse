export default {
  ...
  cookies: {
    title: 'Cookies',
    description:
      'Diese Website verwendet Cookies, um das ordnungsgemäße Funktionieren sicherzustellen und Ihre Nutzererfahrung zu verbessern.',
    ...
    technicalCookiesDescription:
      'Technische Cookies sind für das ordnungsgemäße Funktionieren der Website unerlässlich. Sie gewährleisten Sicherheit, korrekte Darstellung auf verschiedenen Geräten, ermöglichen das Ausfüllen und Absenden von Formularen, die Verwaltung des Warenkorbs und das Anmelden. Ohne diese Cookies funktioniert der Online-Shop nicht. Diese Cookies können nicht abgelehnt werden.',
    marketingCookiesTitle: 'Marketing-Cookies',
    marketingCookiesDescription:
      'Marketing-Cookies dienen dazu, Ihnen relevante Werbung anzuzeigen. Sie helfen uns, die Effektivität unserer Werbekampagnen zu verfolgen und auszuwerten. Diese Cookies können abgelehnt werden.',
    analyticsCookiesTitle: 'Analyse-Cookies',
    analyticsCookiesDescription:
      'Analyse-Cookies liefern uns Informationen darüber, wie Sie unsere Website und Dienste nutzen. Dadurch können wir Inhalte und Benutzererfahrung kontinuierlich verbessern und den Erfolg von Werbekampagnen verfolgen. Diese Cookies können abgelehnt werden.',

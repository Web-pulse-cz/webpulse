        ...
        <div class="flex h-6 shrink-0 items-center">
          <div class="group grid size-4 grid-cols-1">
            <input
              ...
              :checked="checked"
              :disabled="disabled"
              class="border-grayLight checked:bg-dark indeterminate:bg-dark active:bg-dark col-start-1 row-start-1 appearance-none rounded border bg-primary checked:border-secondary indeterminate:border-secondary focus:border-secondary focus:bg-secondary active:border-secondary disabled:border-secondary disabled:bg-secondary disabled:checked:bg-secondary"
            />
            <svg

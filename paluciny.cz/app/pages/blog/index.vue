...
<template>
  <div>
    <LayoutContainer>
      ...
      >
        <span
          class="mb-6 inline-block rounded-full bg-forest/10 px-5 py-2 text-sm font-semibold uppercase tracking-widest text-forest"
        >
          Blog
        </span>

        <h1 class="mb-6 text-4xl font-bold leading-tight text-earth md:text-5xl">
          {{ t('blog.title') }}
        </h1>
      </div>
    </LayoutContainer>

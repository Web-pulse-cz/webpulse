  ...
  <TransitionRoot as="template" :show="open">
    <Dialog class="relative z-10" @close="$emit('close')">
      <TransitionChild
        ...
        leave-to="opacity-0"
      >
        <div class="fixed inset-0 bg-earth/50 transition-opacity" />
      </TransitionChild>
      ...
      <div class="fixed inset-0 z-10 w-full overflow-y-auto">
        ...
        >
          ...
          >
            <DialogPanel
              class="relative transform overflow-hidden rounded-3xl border border-cream-dark bg-cream p-16 py-16 text-left transition-all sm:my-8 sm:max-w-lg"
            >
              <div class="flex items-center justify-between px-4">
                ...
                <button
                  ...
                  class="mb-8 text-4xl font-bold text-earth-light hover:text-forest"
                  @click="$emit('close')"
                >
                  &times;
                </button>
              ...
              <Form @submit="onSubmit">
                <div class="grid grid-cols-1 gap-4">
                  ...
                  <BaseFormTextarea
                    ...
                    :variant="variant"
                  />
                  <p class="px-4 text-sm/6 text-earth-light">
                    {{ t('contactForm.submitForm') }}
                    <!-- TODO: Add link to privacy policy -->
                    <NuxtLink to="#" class="font-semibold text-forest underline">

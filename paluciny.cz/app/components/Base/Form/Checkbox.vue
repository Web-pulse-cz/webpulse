    ...
    <div class="space-y-5">
      <div class="flex gap-3">
        <div class="flex h-6 shrink-0 items-center">
          <div class="group grid size-4 grid-cols-1">
            <input
              ...
              :checked="checked"
              :disabled="disabled"
              class="col-start-1 row-start-1 appearance-none rounded border border-earth-light/30 bg-white checked:border-forest checked:bg-forest indeterminate:border-forest indeterminate:bg-forest focus:border-forest focus:bg-white active:border-forest active:bg-forest disabled:border-earth-light/20 disabled:bg-cream-dark disabled:checked:bg-earth-light"
            />
            <svg
        ...
        <div class="text-xs lg:text-sm/6">
          ...
          <label v-else :for="name" class="font-medium text-gray-900">{{ label }}</label>
        </div>
      </div>
    </div>
  </fieldset>

...
<template>
  <section class="bg-cream px-6 py-16 lg:py-24">
    <div class="mx-auto max-w-4xl overflow-hidden rounded-3xl bg-forest p-8 md:p-16">
      <h2 class="mb-8 text-center font-display text-3xl font-bold text-white md:text-4xl">
        Kontakt
      </h2>

...
use App\Http\Resources\Admin\Food\Meal\MealCategoryResource;
use App\Models\Food\Meal\MealCategory;
...
class MealCategoryController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        if ($request->has('paginate')) {
            ...
            return Response::json([
                'data' => MealCategoryResource::collection($categories->items()),
        ...
        return Response::json(MealCategoryResource::collection($categories));
    }
    ...
    public function store(Request $request, int $id = null): JsonResponse
    {
        ...
        DB::beginTransaction();
        try {
            $category->fill($request->only('meal_category_id'));
            ...
            DB::rollBack();
            return Response::json(['message' => 'An error occurred while saving meal category.'], 500);
        }

        return Response::json(MealCategoryResource::make($category));
    }

...
use App\Http\Resources\Admin\Season\SeasonResource;
...
class SeasonController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        if ($request->has('paginate')) {
            ...
            return Response::json([
                'data' => SeasonResource::collection($items->items()),
                'total' => $items->total(),
        ...
        return Response::json(SeasonResource::collection($query->get()));
    }
    ...
    public function show(Request $request, int $id): JsonResponse
    {
        ...
        $item = Season::whereRelation('sites', 'site_id', $siteId)->find($id);
        if (! $item) {
            App::abort(404);
        }

        return Response::json(SeasonResource::make($item));
    }
    ...
    public function store(Request $request, ?int $id = null)
    {
        ...
        try {
            ...
            return Response::json(SeasonResource::make($item->fresh()));
        } catch (\Throwable $e) {
            DB::rollBack();

            return Response::json(['error' => 'An error occurred while saving the season.'], 500);
        }
    }

...
const pageTitle = ref('Události a akce');
...
async function loadItems() {
  ...
  await client<{ id: number }>('/api/admin/event', {
    method: 'GET',
    ...
    .catch(() => {
      ...
      toast.add({
        title: 'Chyba',
        description: 'Nepodařilo se načíst události. Zkuste to prosím později.',
        color: 'red',
      });
    })
    .finally(() => {
...
async function deleteItem(id: number) {
  ...
  await client<{ id: number }>('/api/admin/event/' + id, {
    method: 'DELETE',
    headers: {
      Accept: 'application/json',
      'Content-Type': 'application/json',
    ...
    .catch(() => {
      ...
      toast.add({
        title: 'Chyba',
        description: 'Nepodařilo se smazat položku události.',
        color: 'red',
      });
    })
    .finally(() => {

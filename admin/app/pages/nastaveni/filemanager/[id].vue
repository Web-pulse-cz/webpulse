        ...
        <div class="col-span-1 space-y-8 lg:col-span-9">
          <LayoutContainer>
            ...
            <div class="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-6">
              ...
              />
              <BaseFormInput v-model="item.width" label="Šířka (px)" type="number" name="width" />
              <BaseFormInput v-model="item.height" label="Výška (px)" type="number" name="height" />
              <BaseFormInput
                v-model="item.path"
          ...
          <LayoutContainer>
            ...
            <div class="mt-6 rounded-2xl bg-slate-50 p-4 text-xs leading-relaxed text-slate-600">
              <p>
                <strong>Cover</strong> — obrázek vyplní celý rámec a ořeže se podle pozice (žádné
                bílé pozadí).
              </p>
              <p>
                <strong>Contain</strong> — celý obrázek se vejde, prázdné místo se doplní pozadím.
              </p>

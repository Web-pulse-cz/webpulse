...
<template>
	<div>
		<LayoutHeader :title="pageTitle" :breadcrumbs="breadcrumbs" :actions="[{ type: 'add', text: 'Přidat šablonu' }]" slug="shifts" />
		<BaseTable
			:items="items"
			:columns="[
				...
				{ key: 'break_minutes', name: 'Přestávka (min)', type: 'number', width: 100, hidden: true, sortable: false },
			]"
			:actions="[{ type: 'edit' }, { type: 'delete' }]"
			:loading="loading" :error="false"
			singular="Šablona" plural="Šablony směn"
			slug="shifts"

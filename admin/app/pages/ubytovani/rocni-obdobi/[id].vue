  ...
  await client('/api/admin/season/' + route.params.id, {
    ...
    .then((response: any) => {
      ...
      breadcrumbs.value.push({
        ...
        link: '/ubytovani/rocni-obdobi/' + route.params.id,
        current: true,
      });
  ...
  await client(
    ...
    .then((response: any) => {
      ...
      if (!redirect && route.params.id === 'pridat')
        router.push('/ubytovani/rocni-obdobi/' + response.id);
          ...
          <LayoutContainer>
            ...
            <div class="grid grid-cols-1 gap-y-6">
              ...
              <div
                ...
                class="grid grid-cols-1 gap-y-4 rounded-2xl bg-slate-50 p-6 sm:grid-cols-4 sm:gap-x-4"
              >
                <BaseFormSelect
              ...
              <div
                v-else
                class="grid grid-cols-1 gap-y-4 rounded-2xl bg-slate-50 p-6 sm:grid-cols-2 sm:gap-x-4"
              >
                <BaseFormInput

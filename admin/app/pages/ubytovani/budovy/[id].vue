				...
				<div class="col-span-1 space-y-8 lg:col-span-9">
					...
					<LayoutContainer>
						...
						<div class="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-6">
							<BaseFormInput v-model="item.address_street" label="Ulice a č.p." type="text" name="address_street" class="sm:col-span-2" />
							<BaseFormInput v-model="item.address_city" label="Město" type="text" name="address_city" />
							<BaseFormInput v-model="item.address_zip" label="PSČ" type="text" name="address_zip" />
							<BaseFormSelect
								v-model="item.country_id"
								label="Země"
								name="country_id"
								:options="countryStore.countries?.map((c: any) => ({ value: c.id, name: c.name })) || []"
							/>
							<BaseFormInput v-model="item.latitude" label="Zeměpisná šířka" type="text" name="latitude" />
							<BaseFormInput v-model="item.longitude" label="Zeměpisná délka" type="text" name="longitude" />
						</div>
					</LayoutContainer>
					...
					<LayoutContainer>
						...
						<div class="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-6">
							<BaseFormInput v-model="item.contact_name" label="Jméno" type="text" name="contact_name" class="sm:col-span-2" />
							<BaseFormInput v-model="item.contact_email" label="E-mail" type="email" name="contact_email" />
							<BaseFormInput v-model="item.contact_phone" label="Telefon" type="text" name="contact_phone" />
						</div>
					</LayoutContainer>

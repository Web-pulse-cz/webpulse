...
const breadcrumbs = ref([
	{ name: pageTitle.value, link: '/smlouvy', current: true },
]);
	...
	<div>
		...
		<BaseTable
			...
			:columns="[
				...
				{ key: 'type', name: 'Typ', type: 'mapped', width: 120, hidden: false, sortable: true, map: {
				...
				{ key: 'employee_name', name: 'Zaměstnanec', type: 'text', width: 150, hidden: false, sortable: false },
				{ key: 'project_name', name: 'Projekt', type: 'text', width: 150, hidden: true, sortable: false },
				...
				{ key: 'created_at', name: 'Vytvořeno', type: 'date', width: 100, hidden: true, sortable: true },
			]"

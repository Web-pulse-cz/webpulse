...
<template>
	<div>
		<LayoutHeader :title="pageTitle" :breadcrumbs="breadcrumbs" :actions="[{ type: 'add', text: 'Přidat sekci' }]" slug="menus" />
		<BaseTable
			:items="items"
			:columns="[
				...
				{ key: 'description', name: 'Popis', type: 'text', width: 200, hidden: true, sortable: false },
				{ key: 'position', name: 'Pořadí', type: 'number', width: 80, hidden: true, sortable: false },
			]"
			:actions="[{ type: 'edit' }, { type: 'delete' }]"
			:loading="loading" :error="false"
			singular="Sekce" plural="Sekce jídelního lístku"
			slug="menus"

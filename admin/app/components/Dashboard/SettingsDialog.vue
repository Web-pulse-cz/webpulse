...
const getTitle = (key: string) => availableWidgets.find((w) => w.key === key)?.title ?? key;
        ...
        <div class="flex min-h-full items-center justify-center p-4">
          ...
          >
            ...
            >
              ...
              <div
                class="mt-6 flex items-center justify-between gap-3 border-t border-slate-100 pt-5"
              >
                <button
                  type="button"
                ...
                <div class="flex items-center gap-3">
                  ...
                  <BaseButton variant="primary" size="md" @click="save"> Uložit </BaseButton>
                </div>
              </div>
            </DialogPanel>
          </TransitionChild>

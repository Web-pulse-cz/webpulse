              ...
              >
                ...
                >
                  <div class="w-full text-left">
                    ...
                    <div class="mt-2 grid w-full grid-cols-1 gap-4 sm:grid-cols-2 sm:gap-6">
                      <BaseFormSelect
                        v-model="filter"
                        name="filter"
                        label="Typ"
                      ...
                      <LayoutDivider class="col-span-full my-2">
                        Datum vytvoření <span class="hidden sm:inline">(pouze kontakty)</span>
                      </LayoutDivider>
